    ...
    <footer className="bg-[#024BBE]  p-10 text-white">
      <div className="container grid grid-cols-1 gap-8 mx-auto text-center md:grid-cols-4 md:text-left">
        ...
        <div>
          ...
          <p className="text-sm text-white">Email: <a href="mailto:support@snabbdeal.com" className="hover:text-white">support@snabbdeal.com</a></p>
          <p className="text-sm text-white">Phone: <a href="tel:+19789280688" className="hover:text-white">+1 (978) 918-0688</a></p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-white">
            ...
            <li><a href="/help" className="hover:text-white">Help & FAQ</a></li>
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          <div className="flex justify-center space-x-6 md:justify-start">
            <a
              href="https://www.facebook.com/people/Snabbdealofficial/61562808394070/"
              target="_blank"
            ...
            <a
              href="https://www.instagram.com/snabbdealofficial"
              target="_blank"
              rel="noopener noreferrer"
              className="transition-transform duration-300 transform hover:scale-110"
            >
            ...
            <a
              href="https://www.linkedin.com/company/37409192/"
              target="_blank"
              rel="noopener noreferrer"
              className="transition-transform duration-300 transform hover:scale-110"
            >
      ...
      <div className="pt-4 mt-8 text-sm text-center text-white">
        &copy; {new Date().getFullYear()} SnabbDeal. All rights reserved.
      </div>
    </footer>
  );
};
